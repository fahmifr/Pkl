		                ...
		                <div class="col-md-12">
                          ...
                          {{ csrf_field() }}
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="noHp" name="noHp" value="{{ Auth::user()->noHp }}" class="form-control here" required="required" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="kodeP" name="kodeP" value="{{ Auth::user()->kodeP }}" class="form-control here" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
